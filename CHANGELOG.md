...
- The acceptance-map self-test is hermetic across CI operating systems: its internal fixture resolver requires no `gh`, network access, or `GH_TOKEN`, while production generation and linting retain independent named-run validation.
