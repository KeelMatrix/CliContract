...
- Informational `KMCLI005` findings for represented metadata, installation guidance, help text, and choice descriptions, while preserving non-gating behavior for both failure thresholds.
