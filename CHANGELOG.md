...
- Compatibility coverage for binary identity, runnable command kind, positional slots, constrained choice removals, default-source resolution, and global file-source configuration.
