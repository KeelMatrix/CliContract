...
- Acceptance-map proof now requires a machine-checkable anchor, binds every named GitHub Actions run to its actual candidate commit, and runs deterministic stale-run/generic-proof regressions in both local CI workflows.
