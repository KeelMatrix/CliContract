...
Supported input: OpenCLI `1.0.0-alpha.14`, in JSON or YAML. Schema parsing and comparison are local after restore; a successful comparison may make one bounded best-effort telemetry request unless telemetry is disabled. The tool does not execute the described CLI.
